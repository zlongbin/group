...
class WeixinController extends Controller
{
    ...
    public $weixin_notify_url = 'http://group.yxxmmm.com/weixin/pay/notice';     //支付通知回调
...
//        echo $oid;die;
        ...
        $order_info = [
            ...
            'sign_type'     => 'MD5',
            'body'          => '订单-'.mt_rand(1111,9999) . str_random(6),
